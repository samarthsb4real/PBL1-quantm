...
Generated on: 2025-04-17 22:27:28
...
- **Internal State**: BLAKE3 uses 8 × 4 × 32-bit state matrix
...
+=================================+=====================+=================+=======================+===================+========================+====================+==========================+======================+
| SHA-256 (FIPS 180-4)            |          8.415e-07  |           72.53 |            9.985e-07  |            978.01 |            9.0059e-06  |            1734.98 |              0.000522663 |              1913.28 |
+---------------------------------+---------------------+-----------------+-----------------------+-------------------+------------------------+--------------------+--------------------------+----------------------+
| SHA-512 (FIPS 180-4)            |          6.328e-07  |           96.45 |            1.7053e-06 |            572.65 |            1.77527e-05 |             880.15 |              0.00110659  |               903.68 |
+---------------------------------+---------------------+-----------------+-----------------------+-------------------+------------------------+--------------------+--------------------------+----------------------+
| Quantum-Safe (SHA-512 + BLAKE3) |          1.5832e-06 |           38.55 |            3.6041e-06 |            270.96 |            2.28478e-05 |             683.87 |              0.00158966  |               629.06 |
+---------------------------------+---------------------+-----------------+-----------------------+-------------------+------------------------+--------------------+--------------------------+----------------------+
```
...
+---------------------------------+-----------------+---------------+-----------+----------+--------------------+
| SHA-512 (FIPS 180-4)            |               1 |             0 | 49.98%    | 50.02%   | OPTIMAL (p > 0.05) |
+---------------------------------+-----------------+---------------+-----------+----------+--------------------+
| Quantum-Safe (SHA-512 + BLAKE3) |               1 |             0 | 50.00%    | 50.00%   | OPTIMAL (p > 0.05) |
+---------------------------------+-----------------+---------------+-----------+----------+--------------------+
```
...
+=================================+==============+================+===========+===============+
| SHA-256 (FIPS 180-4)            | 64 bytes     | 50.06%         |      3.08 |          0.06 |
+---------------------------------+--------------+----------------+-----------+---------------+
| SHA-256 (FIPS 180-4)            | 1024 bytes   | 49.99%         |      3.17 |          0.01 |
+---------------------------------+--------------+----------------+-----------+---------------+
| SHA-512 (FIPS 180-4)            | 64 bytes     | 50.06%         |      2.31 |          0.06 |
+---------------------------------+--------------+----------------+-----------+---------------+
| SHA-512 (FIPS 180-4)            | 1024 bytes   | 49.99%         |      2.14 |          0.01 |
+---------------------------------+--------------+----------------+-----------+---------------+
| Quantum-Safe (SHA-512 + BLAKE3) | 64 bytes     | 49.86%         |      3.13 |          0.14 |
+---------------------------------+--------------+----------------+-----------+---------------+
| Quantum-Safe (SHA-512 + BLAKE3) | 1024 bytes   | 50.00%         |      3.18 |          0    |
+---------------------------------+--------------+----------------+-----------+---------------+
```
...
+==================+==========+==============+===========+==========+============+
| empty            | SUCCESS  | 0.000004s    | 51.95%    | 48.05%   | ✓          |
+------------------+----------+--------------+-----------+----------+------------+
| large            | SUCCESS  | 0.000510s    | 48.05%    | 51.95%   | ✓          |
+------------------+----------+--------------+-----------+----------+------------+
| repeated_pattern | SUCCESS  | 0.000004s    | 46.09%    | 53.91%   | ✓          |
+------------------+----------+--------------+-----------+----------+------------+
| all_zeros        | SUCCESS  | 0.000001s    | 51.17%    | 48.83%   | ✓          |
+------------------+----------+--------------+-----------+----------+------------+
...
| Edge Case        | Status   | Time/Error   | Zeros %   | Ones %   | Balanced   |
+==================+==========+==============+===========+==========+============+
| empty            | SUCCESS  | 0.000005s    | 49.02%    | 50.98%   | ✓          |
+------------------+----------+--------------+-----------+----------+------------+
| large            | SUCCESS  | 0.001073s    | 46.29%    | 53.71%   | ✓          |
+------------------+----------+--------------+-----------+----------+------------+
...
+------------------+----------+--------------+-----------+----------+------------+
| large            | SUCCESS  | 0.001364s    | 53.52%    | 46.48%   | ✓          |
+------------------+----------+--------------+-----------+----------+------------+
...
+=================================+===========+================+===========+==============+
| SHA-256 (FIPS 180-4)            | 1_bytes   | 49.89%         |      3.03 |         0.11 |
+---------------------------------+-----------+----------------+-----------+--------------+
| SHA-256 (FIPS 180-4)            | 2_bytes   | 50.01%         |      3.06 |         0.01 |
+---------------------------------+-----------+----------------+-----------+--------------+
| SHA-256 (FIPS 180-4)            | 4_bytes   | 50.10%         |      3.13 |         0.1  |
+---------------------------------+-----------+----------------+-----------+--------------+
| SHA-256 (FIPS 180-4)            | 8_bytes   | 50.02%         |      3.05 |         0.02 |
+---------------------------------+-----------+----------------+-----------+--------------+
| SHA-512 (FIPS 180-4)            | 1_bytes   | 49.96%         |      2.18 |         0.04 |
+---------------------------------+-----------+----------------+-----------+--------------+
| SHA-512 (FIPS 180-4)            | 2_bytes   | 49.99%         |      2.14 |         0.01 |
+---------------------------------+-----------+----------------+-----------+--------------+
| SHA-512 (FIPS 180-4)            | 4_bytes   | 49.98%         |      2.16 |         0.02 |
+---------------------------------+-----------+----------------+-----------+--------------+
| SHA-512 (FIPS 180-4)            | 8_bytes   | 50.02%         |      2.12 |         0.02 |
+---------------------------------+-----------+----------------+-----------+--------------+
| Quantum-Safe (SHA-512 + BLAKE3) | 1_bytes   | 50.05%         |      3.2  |         0.05 |
+---------------------------------+-----------+----------------+-----------+--------------+
| Quantum-Safe (SHA-512 + BLAKE3) | 2_bytes   | 49.87%         |      3.12 |         0.13 |
+---------------------------------+-----------+----------------+-----------+--------------+
| Quantum-Safe (SHA-512 + BLAKE3) | 4_bytes   | 50.03%         |      3.07 |         0.03 |
+---------------------------------+-----------+----------------+-----------+--------------+
| Quantum-Safe (SHA-512 + BLAKE3) | 8_bytes   | 49.92%         |      3.22 |         0.08 |
+---------------------------------+-----------+----------------+-----------+--------------+
```
...
+=================================+==============+=========+============+=========+================+==========+
| SHA-256 (FIPS 180-4)            | 16 bits      | False   |        100 | 0.0002s | 622002.72/s    | STRONG   |
+---------------------------------+--------------+---------+------------+---------+----------------+----------+
| SHA-512 (FIPS 180-4)            | 16 bits      | False   |        100 | 0.0002s | 562895.08/s    | STRONG   |
+---------------------------------+--------------+---------+------------+---------+----------------+----------+
| Quantum-Safe (SHA-512 + BLAKE3) | 16 bits      | False   |        100 | 0.0003s | 344065.89/s    | STRONG   |
+---------------------------------+--------------+---------+------------+---------+----------------+----------+
```
...
1. **SHA-256 (FIPS 180-4)**: Overall Score: 0.9998
   - Performance: 1.0000, Entropy: 1.0000, Avalanche: 0.9993, Collision Resistance: Passed
2. **SHA-512 (FIPS 180-4)**: Overall Score: 0.8415
   - Performance: 0.4723, Entropy: 1.0000, Avalanche: 0.9993, Collision Resistance: Passed
3. **Quantum-Safe (SHA-512 + BLAKE3)**: Overall Score: 0.7982
   - Performance: 0.3288, Entropy: 1.0000, Avalanche: 0.9986, Collision Resistance: Passed