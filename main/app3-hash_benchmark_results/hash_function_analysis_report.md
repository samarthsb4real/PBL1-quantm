...
Generated on: 2025-03-22 14:37:31
...
+=================+=====================+=================+=======================+===================+========================+====================+==========================+======================+
| SHA-512         |           1.027e-06 |           59.43 |            1.7282e-06 |            565.06 |            1.75734e-05 |             889.13 |               0.00108467 |               921.94 |
+-----------------+---------------------+-----------------+-----------------------+-------------------+------------------------+--------------------+--------------------------+----------------------+
| Quantum-Safe    |           1.516e-06 |           40.26 |            3.691e-06  |            264.58 |            2.24651e-05 |             695.52 |               0.00153587 |               651.1  |
+-----------------+---------------------+-----------------+-----------------------+-------------------+------------------------+--------------------+--------------------------+----------------------+
```
...
+=================+=================+===============+===========+==========+====================+
| SHA-512         |               1 |             0 | 50.00%    | 50.00%   | OPTIMAL (p > 0.05) |
+-----------------+-----------------+---------------+-----------+----------+--------------------+
| Quantum-Safe    |               1 |             0 | 49.99%    | 50.01%   | OPTIMAL (p > 0.05) |
+-----------------+-----------------+---------------+-----------+----------+--------------------+
```
...
+=================+==============+================+===========+===============+
| SHA-512         | 64 bytes     | 50.12%         |      2.27 |          0.12 |
+-----------------+--------------+----------------+-----------+---------------+
| SHA-512         | 1024 bytes   | 50.01%         |      2.19 |          0.01 |
+-----------------+--------------+----------------+-----------+---------------+
| Quantum-Safe    | 64 bytes     | 49.95%         |      3.13 |          0.05 |
+-----------------+--------------+----------------+-----------+---------------+
| Quantum-Safe    | 1024 bytes   | 50.15%         |      3.14 |          0.15 |
+-----------------+--------------+----------------+-----------+---------------+
```
...
+==================+==========+==============+===========+==========+============+
| empty            | SUCCESS  | 0.000010s    | 49.02%    | 50.98%   | ✓          |
+------------------+----------+--------------+-----------+----------+------------+
| large            | SUCCESS  | 0.001058s    | 46.29%    | 53.71%   | ✓          |
+------------------+----------+--------------+-----------+----------+------------+
...
+=================+===========+================+===========+==============+
| SHA-512         | 1_bytes   | 49.97%         |      2.16 |         0.03 |
+-----------------+-----------+----------------+-----------+--------------+
| SHA-512         | 2_bytes   | 50.05%         |      2.25 |         0.05 |
+-----------------+-----------+----------------+-----------+--------------+
| SHA-512         | 4_bytes   | 49.97%         |      2.13 |         0.03 |
+-----------------+-----------+----------------+-----------+--------------+
| SHA-512         | 8_bytes   | 49.97%         |      2.13 |         0.03 |
+-----------------+-----------+----------------+-----------+--------------+
| Quantum-Safe    | 1_bytes   | 50.04%         |      3.14 |         0.04 |
+-----------------+-----------+----------------+-----------+--------------+
| Quantum-Safe    | 2_bytes   | 50.02%         |      3.31 |         0.02 |
+-----------------+-----------+----------------+-----------+--------------+
| Quantum-Safe    | 4_bytes   | 50.07%         |      3.15 |         0.07 |
+-----------------+-----------+----------------+-----------+--------------+
| Quantum-Safe    | 8_bytes   | 49.93%         |      3.14 |         0.07 |
+-----------------+-----------+----------------+-----------+--------------+
```
...
+=================+==============+=========+============+=========+================+==========+
| SHA-512         | 16 bits      | False   |        100 | 0.0002s | 568663.24/s    | STRONG   |
+-----------------+--------------+---------+------------+---------+----------------+----------+
| Quantum-Safe    | 16 bits      | False   |        100 | 0.0003s | 329416.57/s    | STRONG   |
+-----------------+--------------+---------+------------+---------+----------------+----------+
```
...
1. **SHA-512**: Overall Score: 0.9996
   - Performance: 1.0000, Entropy: 1.0000, Avalanche: 0.9987, Collision Resistance: Passed
2. **Quantum-Safe**: Overall Score: 0.9113
   - Performance: 0.7062, Entropy: 1.0000, Avalanche: 0.9980, Collision Resistance: Passed
